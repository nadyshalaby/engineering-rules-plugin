...
- Why-this-matters: Loads the frontend design law (15.1, binding). A selects the committed spec as authority; B and C route to 15.5 (Mode B and Mode A); D routes to 15.4.
...
- Why-this-matters: A keeps the committed `DESIGN.md` binding and scopes the design-conformance check (12.5) to conformance. B and C make authoring or refreshing `docs/design/DESIGN.md` an explicit Phase 2 deliverable, before any component, and require sign-off at the gate.
