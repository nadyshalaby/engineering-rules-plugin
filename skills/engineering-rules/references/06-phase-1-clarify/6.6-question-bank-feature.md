...
- Why-this-matters: Triggers (or skips) the frontend design law (15.1) and makes the design-conformance check (12.5) a standing reviewer on the diff for any answer other than A.
...
- Why-this-matters: A makes the committed spec's tokens binding in Phase 3. B routes to 15.5 Mode A. C routes to 15.4 and 15.6 and makes `docs/design/DESIGN.md` the first deliverable, authored BEFORE any component (15.19).
