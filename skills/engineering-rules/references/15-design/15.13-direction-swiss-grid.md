# 15.13 [direction] Direction, swiss-grid
...
**Dials.** `DESIGN_VARIANCE` 3, `MOTION_INTENSITY` 1, `VISUAL_DENSITY` 5 (15.20). Variance comes from asymmetric spans on the grid, never from breaking it.
