# 15.7 [direction] Direction, industrial-precision

## Industrial Precision (`industrial-precision`)
...
**Dials.** `DESIGN_VARIANCE` 3, `MOTION_INTENSITY` 2, `VISUAL_DENSITY` 7 (15.20). The read may move each by one; a wider move is a direction question.
