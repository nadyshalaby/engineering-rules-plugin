# 15.16 [direction] Direction, nordic-calm
...
**Dials.** `DESIGN_VARIANCE` 4, `MOTION_INTENSITY` 3, `VISUAL_DENSITY` 2 (15.20). Whitespace is the structure, so density stays in the bottom band.
