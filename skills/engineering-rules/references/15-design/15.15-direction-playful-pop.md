# 15.15 [direction] Direction, playful-pop
...
**Dials.** `DESIGN_VARIANCE` 7, `MOTION_INTENSITY` 8, `VISUAL_DENSITY` 4 (15.20). Motion 8 means physics on interaction, never loops on idle cards.
