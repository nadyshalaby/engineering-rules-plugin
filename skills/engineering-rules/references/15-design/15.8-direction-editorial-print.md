# 15.8 [direction] Direction, editorial-print
...
**Dials.** `DESIGN_VARIANCE` 6, `MOTION_INTENSITY` 3, `VISUAL_DENSITY` 3 (15.20). The variance lives in the grid breaks and the type scale, never in motion.
