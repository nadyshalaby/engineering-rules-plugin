# 15.17 [direction] Direction, cyber-neon
...
**Dials.** `DESIGN_VARIANCE` 7, `MOTION_INTENSITY` 7, `VISUAL_DENSITY` 5 (15.20). Motion 7 is scanning highlights and live pulses, still transform and opacity only (15.25).
