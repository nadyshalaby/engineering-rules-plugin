# 15.9 [direction] Direction, retro-terminal
...
**Dials.** `DESIGN_VARIANCE` 2, `MOTION_INTENSITY` 2, `VISUAL_DENSITY` 8 (15.20). Density is the identity; variance above 3 starts to look like a theme park.
